...
export default function LeaderboardPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto", padding: "24px 16px 64px" }}>
        ...
        <div style={card}>
          ...
          <div style={thead}>
            ...
            <div style={{ flex: 1, textAlign: "center" }}>X Handle</div>
          ...
          {!loading && !err && rows.length > 0 && rows.map((p, idx) => {
            ...
            const xHandle = fmtHandle(p?.twitter, p?.username);
            return (
              <div key={`${p.username ?? "u"}-${idx}`} style={trow(idx)}>
                <div style={{ width: 52 }}>
                ...
                <div style={{ flex: 1, textAlign: "center", color: "#cbd5e1", fontWeight: 600 }}>
                  {xHandle}
                </div>
      ...
      {/* Refresh hook from the admin panel */}
